...
const routes: Routes = [
  ...
  {
    path: 'exam',
    loadChildren: () => import('./faculty/exam/exam.module').then( m => m.ExamPageModule),
    canActivate: [AaaGuard]
  },
  {
    path: 'bluck-attendance',
    loadChildren: () => import('./faculty/bluck-attendance/bluck-attendance.module').then( m => m.BluckAttendancePageModule)
  },
