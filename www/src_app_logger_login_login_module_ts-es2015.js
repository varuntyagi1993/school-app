...
/* harmony import */ var _login_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./login.page */ 93667);
...
/* harmony import */ var _login_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./login-routing.module */ 55986);
/* harmony import */ var _login_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./login.page */ 93667);
...
/* harmony import */ var _raw_loader_login_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./login.page.html */ 24120);
/* harmony import */ var _login_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./login.page.scss */ 71820);
...
/* harmony import */ var _services_payment_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../services/payment.service */ 51863);
...
let LoginPage = class LoginPage {
    constructor(menu, router, auth, generalts, navCtrl, activatedrouted, alertController, payService) {
        this.menu = menu;
        this.router = router;
        this.auth = auth;
    ...
    login() {
        ...
        if ([null, "", undefined].indexOf(this.user) > -1 ||
            ...
            this.auth.postt(data, "login", faculty).subscribe(response => {
...
let PaymentService = class PaymentService {
    constructor(router, platform, toastCtrl, http, alertController) {
        this.router = router;
    ...
    switch_to_ewallet_api(page, item) {
        console.log(page);
        return this.http
            .post(this.base_path + page, JSON.stringify(item), this.httpOptions);
    }
    get_data(page, token) {
        let f = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__.HttpHeaders({
...
PaymentService = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
