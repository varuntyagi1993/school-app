  ...
  (self["webpackChunkschool_app"] = self["webpackChunkschool_app"] || []).push([["src_app_logger_signup_signup_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _SignupPage = /*#__PURE__*/function () {
        function SignupPage(router, activatedrouted, auth, generalts) {
        ...
        _createClass(SignupPage, [{
          ...
          value: function for_otp() {
            ...
            if ([null, "", undefined].indexOf(this.mob_num) > -1) {
              ...
              this.auth.postt(mob, this.page).subscribe(function (sa) {
                ...
                if (sa) {
                  _this.router.navigate(["/otpcheck", {
...
//# sourceMappingURL=src_app_logger_signup_signup_module_ts-es5.js.map