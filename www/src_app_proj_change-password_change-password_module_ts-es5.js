(function () {
  ...
  (self["webpackChunkschool_app"] = self["webpackChunkschool_app"] || []).push([["src_app_proj_change-password_change-password_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _ChangePasswordPageRoutingModule = /*#__PURE__*/_createClass(function ChangePasswordPageRoutingModule() {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _ChangePasswordPageModule = /*#__PURE__*/_createClass(function ChangePasswordPageModule() {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _ChangePasswordPage = /*#__PURE__*/function () {
        function ChangePasswordPage(formBuilder, authService, router, generalts, actroute) {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  ...
                  case 5:
                    ...
                    this.authService.g_postt(pas, "change-password", token).subscribe(function (sa) {
                      console.log(sa, "da");
                      ...
                      if (sa.message) {
                        ...
                        localStorage.setItem("*/", _this.mob); //localStorage.setItem("asd", this.mob);
      ...
      _ChangePasswordPage = (0, tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
...
//# sourceMappingURL=src_app_proj_change-password_change-password_module_ts-es5.js.map